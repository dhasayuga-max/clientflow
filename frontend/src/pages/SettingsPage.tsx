...
export default function SettingsPage() {
  ...
  const companyForm = useForm({ defaultValues: { name: '', address: '', gstNumber: '', phone: '', website: '', email: '' } });
  ...
  useEffect(() => {
    if (settingsData) {
      ...
      if (settingsData.company?.logo) setLogoPreview(settingsData.company.logo);
    }
  }, [settingsData]);
